...
def run_test_count_sines_from():
    ...
    expected = 69
    answer = count_sines_from(4, 106)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    expected = 1349
    answer = count_sines_from(0, 2019)
...
def run_test_count_sines_vs_cosines():
    ...
    expected = 2000
    answer = count_sines_vs_cosines(2000)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)
    ...
    expected = 236
    answer = count_sines_vs_cosines(235)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    expected = 400
    answer = count_sines_vs_cosines(399)
    print('Test 6 expected:', expected)
    print('       actual:  ', answer)
